...
const LoginPage = () => {
    let {loginUser} = useContext(AuthContext)         // coming from the context file, authcontext
    ...
    <div className="row">
      <div className="col-sm-6 text-black">
        ...
        <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5" style={{border:'1px solid black'}}>
          ...
          <form style={{width: "50rem"}} onSubmit={handleSubmit(loginUser)}>  {/* when the user is logged in we have to fire off the loginuser function */}
