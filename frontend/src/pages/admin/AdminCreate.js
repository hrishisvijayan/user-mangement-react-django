    ...
    <div>
      <Row className='vh-100 align-items-center justify-content-center card py-5'>
        ...
        <Form.Group className="mb-3" controlId="formBasicUsername">
            ...
            <Form.Control {...register('email')} type="text" placeholder="Enter Email" name='email' />
        ...
        <Form.Group className="mb-3" controlId="formBasicPassword">
            ...
            <Form.Control {...register('repassword')} type="password" placeholder="Conform Password" name='repassword' />
